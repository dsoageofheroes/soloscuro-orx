...
extern int sol_dnd2e_alignment_allowed(soloscuro_state_t *state, const uint8_t alignment, const sol_class_t classes[3], int target_is_pc) {
    int allowed = 1;
    gff_game_type_t game_type = gff_manager_game_type(state->man);
