#ifndef SOLOSCURO_COMBAT_H
#define SOLOSCURO_COMBAT_H

#include "soloscuro/effect.h"
...
extern int sol_combat_set_scmd(sol_entity_t *e, const sol_combat_scmd_t scmd);
extern int sol_combat_update_scmd_info(sol_entity_t *dude);
//extern int sol_combat_get_scmd(const sol_combat_scmd_t type, scmd_t **);
//extern int sol_combat_active(sol_combat_region_t *cr);
...
extern int sol_combat_kill_all_enemies();
