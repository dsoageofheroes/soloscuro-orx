...
extern int sol_power_list_create(sol_power_list_t **p);
extern int sol_power_list_free(sol_power_list_t *pl);
extern int sol_power_list_add(sol_power_list_t *pl, sol_power_t *pw);

extern int sol_powers_init();
extern int sol_powers_cleanup();
extern int sol_powers_set_cast(sol_power_t *powers, const uint32_t id);
extern int sol_powers_set_icon(sol_power_t *powers, const uint32_t id);
extern int sol_powers_set_thrown(sol_power_t *powers, const uint32_t id);
extern int sol_powers_set_hit(sol_power_t *powers, const uint32_t id);
extern int sol_powers_load(sol_power_t *powers);
extern int sol_power_free(sol_power_t *pw);
extern int sol_power_create(sol_power_t **p);
//extern int sol_power_get_icon(sol_power_t *pw, animate_sprite_t **a);
extern int sol_power_get_target_type(sol_power_t *power, enum sol_target_shape_e *e);
extern int sol_power_select_by_game(const size_t ds1, const size_t ds2, const size_t dso, size_t *what);
extern int sol_power_spin_read_description(const uint16_t id, char **msg);
